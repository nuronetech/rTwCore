...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0xad8dd144b354813febbf81b0c4878a5c45e8eec53eb4ebdd83ffba894410164d"));
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1558072548;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 555659;
 
	hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x4eeaea781ebf5b2ca3806e2e3dd2b7285900cdb9516526a147c95e5e9ca0f02a"));
        assert(genesis.hashMerkleRoot == uint256("0x61ab943e7f4e7048f88ab177ef15db8c88f6f10521ec9af071f0a568fdb180a4"));

    	//vSeeds.push_back(CDNSSeedData("206.189.149.106", "206.189.149.106"));             // seed1
