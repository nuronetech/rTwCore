...
#ifndef MUBDI_MASTERNODE_PAYMENTS_H
#define MUBDI_MASTERNODE_PAYMENTS_H
...
public:
    ...
    void ProcessMessageMasternodePayments(CNode* pfrom, std::string& strCommand, CDataStream& vRecv);
    std::string GetRequiredPaymentsString(int nBlockHeight);
    void FillBlockPayee(CMutableTransaction& txNew, int64_t nFees, bool fProofOfStake, bool fZMuBdIStake);
...
#endif /* MUBDI_MASTERNODE_PAYMENTS_H */