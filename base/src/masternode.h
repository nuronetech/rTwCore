...
#ifndef MUBDI_MASTERNODE_H
#define MUBDI_MASTERNODE_H
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 MuBdI, signature to prove
