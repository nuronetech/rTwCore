...
#ifndef MUBDI_OBFUSCATION_H
#define MUBDI_OBFUSCATION_H
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 MuBdI - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of mubdi.
