                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zMuBdI || context == Context::BIP_38) {
        ui->anonymizationCheckBox->setChecked(true);
    }
    else {
        ui->anonymizationCheckBox->setChecked(false);
    }
     // It doesn't make sense to show the checkbox for sending MuBdI because you wouldn't check it anyway.
    if (context == Context::Send_MuBdI || context == Context::Send_zMuBdI) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR rTw</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
