...
QString MuBdIUnits::name(int unit)
{
...
QString MuBdIUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
QString MuBdIUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    QSettings settings;
...
QString MuBdIUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
