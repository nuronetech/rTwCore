                                                                    ...
                                                                    model(0)
{
    ...
    ui->signatureOut_SM->setFont(GUIUtil::MuBdIAddressFont());
    ui->signatureIn_VM->setFont(GUIUtil::MuBdIAddressFont());
}
...
{
    CMuBdIAddress addr(ui->addressIn_VM->text().toStdString());
    if (!addr.IsValid()) {
