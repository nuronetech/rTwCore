...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("AR Stake");
    case TransactionRecord::StakeZMuBdI:
        return tr("zAR Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted rTw to zrTw");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zrTw");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received rTw from zrTw");
    case TransactionRecord::ZerocoinSpend_Change_zMuBdI:
        return tr("Minted Change as zrTw from zrTw Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zrTw to rTw");
