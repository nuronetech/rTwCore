...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zMuBdIObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zMuBdIObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zMuBdIObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zMuBdIsupply", zMuBdIObj));
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zMuBdIsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zAR denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zAR denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zAR denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zAR denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zAR denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zAR denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zAR denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zAR denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zAR denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"mubdiaddress\"   	 	(string) aria address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
...
UniValue getinvalid (const UniValue& params, bool fHelp)
{
    ...
    map<CMuBdIAddress, CAmount> mapBanAddress;
