...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"mubdiprivkey\" ( \"label\" rescan )\n"
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"mubdiaddress\"   (string, required) The aria address for the private key\n"
            "\nResult:\n"
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"mubdiaddress\"\n"
            "\nEncrypts a private key corresponding to 'mubdiaddress'.\n"
            "\nArguments:\n"
            "1. \"mubdiaddress\"   (string, required) The aria address for the private key (you must hold the key already)\n"
