...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Recycle server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MuBdI features */
        /*{"mubdi", "masternode", &masternode, true, true, false},
        ...
        {"mubdi", "mnbudget", &mnbudget, true, true, false},
...
#ifdef ENABLE_WALLET
        //{"mubdi", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43088/\n";
}
