...
#tar
cd ~/coins/recycle/base && tar -xvf plugin_zero.tar.gz && cd src/test && tar -xvf py.tar.gz
#chmod
cd ~/coins/recycle/base && chmod 755 -R build-aux && chmod 755 -R depends && chmod 755 -R qa && chmod 755 -R share && chmod 755 -R mubdi.sh
cd ~/coins/recycle/base && chmod 755 -R src/leveldb && chmod 755 -R src/univalue
#main
cd ~/coins/recycle/base &&./mubdi.sh && ./configure --enable-cxx --disable-shared --enable-hardening --disable-tests --without-gui --with-incompatible-bdb && make && make install
cd ~/coins/recycle && rm -rf base && rm -rf src 
}
